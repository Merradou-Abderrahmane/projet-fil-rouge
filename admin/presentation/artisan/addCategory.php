...
require_once '../../manager/artisanManager.php';
	...
	if (!empty($_POST)) {
		...
		$artisanManager->insertCategory($category);
                        ...
                        <a class="nav-link" href="search.php">
                            ...
                            <a class="nav-link" href="artisan/addCategory.php">
                                <div class="sb-nav-link-icon">
                                    <i class="fa fa-fw fa-plus-circle"></i></div>
                            Add Category <br>
                        </a>			
					</div>
				</div>
					...
					<div id="formCard" class="card mb-4 ">
						...
						<div class="card-body">
							<form method="POST" enctype="multipart/form-data" id="formSubmit" class="row g-3">
								...
								<div class="col-12">
									<label for="inputPrix" class="form-label">Category</label>
									<input type="text" required name="category" class="form-control" id="inputPrix">
								</div>
